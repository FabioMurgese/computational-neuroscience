%%%%%%%%%%%%%%% Time Delay Neural Network - MG task %%%%%%%%%%%%%%%
clear variables;
...
savefig('idnn/idnn_mg_learning_curve')
print(fig,'idnn/idnn_mg_learning_curve.png','-dpng')
...
savefig('idnn/idnn_mg_target_predictions')
print(fig,'idnn/idnn_mg_target_predictions.png','-dpng')